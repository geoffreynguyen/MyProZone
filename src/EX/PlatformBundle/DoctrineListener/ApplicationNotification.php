<?php
// src/EX/PlatformBundle/DoctrineListener/ApplicationNotification.php

namespace EX\PlatformBundle\DoctrineListener;

use Doctrine\ORM\Event\LifecycleEventArgs;
use EX\PlatformBundle\Entity\Application;
